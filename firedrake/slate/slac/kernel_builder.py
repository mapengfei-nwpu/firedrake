...
class LocalLoopyKernelBuilder(object):
    ...
    def __init__(self, expression, tsfc_parameters=None):
        ...
        for tensor in expression_dag:
            ...
            # print('\nbuilder init, before tensor isinstance tensor:', tensor)
            # for slate_tensor, gem_indexed in temps.items():
            #     print('slate tensor:', slate_tensor, '; gem_indexed: ', gem_indexed)
            # Terminal tensors will always require a temporary.
            if isinstance(tensor, slate.Tensor):
                ...
                temps.setdefault(tensor, gem.StructuredSparseVariable("T%d" % len(temps), shape))
                ...
                # print('\nbuilder init, builder:', self)
                # for slate_tensor, gem_indexed in temps.items():
                #     print('slate tensor:', slate_tensor, ' \ngem_indexed: ', gem_indexed)
        ...
        print('before _setup in LocalLoopyKernelBuilder')
        self._setup()
